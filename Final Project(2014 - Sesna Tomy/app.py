...
tab1, tab2, tab3, tab4 = st.tabs(["Classifier", "About Dataset", "Training Images", "Models"])
...
with tab3:
    ...
    # Function to get random images from each folder in a grid layout
    def display_random_images(data_folder, num_images_per_folder=5, num_columns=3):
        for folder in os.listdir(data_folder):
            ...
            for i, image_file in enumerate(selected_images):
                ...
                col1.image(image_path, caption=image_file)

# Specify your data folder
    data_folder = '/home/sesna/sesna/image_classification/data'

# Display random images from each folder in rows and columns
    display_random_images(data_folder, num_images_per_folder=5, num_columns=3)
...
with tab4:
    ...
    st.write("It has trouble with street and buildings. Well, it can be understandable as as there are buildings in the street.")
    st.write("It has also trouble with sea, glacier and moutain as well. However, it can detects forest very accurately!")
    ...
    accuracy1 = accuracy_score(test_labels, pred_labels)
    st.write(f"Accuracy of the model after:",{accuracy1})
